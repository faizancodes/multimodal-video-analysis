import { formatTranscriptIntoSentences, formatTranscriptWithTimestamps, formatTimestamp } from './transcriptFormatter'
...
console.log('Formatted sentences:', JSON.stringify(formattedSentences, null, 2))

console.log('\n=== Testing formatTranscriptWithTimestamps ===')
const sentencesWithTimestamps = formatTranscriptWithTimestamps(sampleTranscript)
console.log('Sentences with timestamps:', JSON.stringify(sentencesWithTimestamps, null, 2))

console.log('\n=== Manual Verification ===')
sentencesWithTimestamps.forEach((sentence, index) => {
  console.log(`Sentence ${index + 1}:`)
  console.log(`  Text: "${sentence.text}"`)
  console.log(`  Start: ${sentence.formattedStartTime} (${sentence.startTime}s)`)
